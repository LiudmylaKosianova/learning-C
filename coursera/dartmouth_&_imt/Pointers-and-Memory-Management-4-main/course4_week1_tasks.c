...
void behind(int*arr, int NN){
 //I will find the maximum score
 int max = 0;
 int i;
 for(i=0;i<NN;i++) {
 if(arr[i]>max){max=arr[i];}
 }
 //I will replace the scores with the number by which they are behind
 for (i=0;i<NN;i++){arr[i] = max - arr[i];}
 }
